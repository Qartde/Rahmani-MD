...
zokou(
    ...
    async (dest, zk, commandeOptions) => {
        ...
        let z =
            "Hello I'm *RAMADHANI Md* \n\n " +
            "I'm a Whatsapp Bot Multi-Device";
        let d = " Made By *Fredie Sir*";
        let varmess = z + d;
        var img = "https://imgur.com/a/eh6t3Fi.jpeg";
...
const sentMsg3  = await zk.sendMessage(dest, { text: '@255697608274', mentions: ['12345678901@s.whatsapp.net'] })
// send a location!
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=255697608274\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
const templateButtons = [
    ...
    {index: 2, callButton: {displayText: 'Call me!', phoneNumber: '255697608274'}},
...
const sections = [
    ...
    },
   {
	...
	rows: [
	    ...
	    {title: "Option 4", rowId: "option4", description: "This is a description 𝑹𝑨𝑯𝑴𝑨𝑵𝑰_𝑴𝑫"}
	]
    },
]
