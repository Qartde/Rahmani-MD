...
zokou({ nomCom: 'channel',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`Support Here My Owner By Follow This Channel Please :https://whatsapp.com/channel/0029VacQFw65Ui2gGv0Kwk1r`) 
...
zokou({ nomCom: 'luckytgc',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*Tap Here To Join Creepy technology Telegram Chatroom* https://t.me/+u3zlb5y6OfxhOTdk`) 
...
zokou({ nomCom: 'update',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*_Ramadhani md is running on its latest vision_*`) 
